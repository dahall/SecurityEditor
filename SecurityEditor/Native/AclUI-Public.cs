...
public enum AccessFlags : uint
{
	...
	/// security page only if the <see cref="Windows.Forms.AccessControlEditorDialog.ObjectIsContainer"/> is <c>true</c>.
	/// </summary>
	Container = 0x40000,
	...
	/// <summary>Indicates a property-specific access right. Used with <see cref="Windows.Forms.AccessControlEditorDialog.EditProperties"/>.</summary>
	Property = 0x80000,
...
/// <summary>Indicate the types of ACEs that can be inherited in a <see cref="InheritTypeInfo"/> structure.</summary>
[Flags]
...
public enum ObjInfoFlags : uint
{
	...
	/// <summary>
	/// This is the default value. The basic security property page always displays the controls for basic editing of the object's DACL.
	/// To disable these controls, set the ReadOnly flag.
	/// </summary>
	EditPerms = 0,
	...
	/// ISecurityInformation::GetSecurity method returns AccessDenied, the user can try to add a new ACE, and a more appropriate warning
	/// is displayed.
	/// </summary>
	MayWrite = 0x10000000,
	...
	/// the user clears the check box, any inherited ACEs in the security descriptor are deleted or converted to noninherited ACEs.
	...
	/// requested when the user does not have WRITE_OWNER access. This flag is valid only if the owner page is requested. Windows Server
	...
	/// <summary>
	/// If this flag is set, an image of a shield is displayed on the Edit button of the simple and advanced Permissions pages. For NTFS
	/// objects, this flag is requested when the user does not have READ_CONTROL or WRITE_DAC access. Windows Server 2003 and Windows XP:
...
/// <summary>
/// Structure contains information about an access right or default access mask for a securable object. The <see
/// cref="IAccessControlEditorDialogProvider.GetAccessListInfo"/> method uses this structure to specify information that the access
/// control editor uses to initialize its property pages.
/// </summary>
/// <remarks>Initializes a new instance of the <see cref="AccessRightInfo"/> struct.</remarks>
/// <param name="mask">The access mask.</param>
/// <param name="name">The display name.</param>
/// <param name="flags">The access flags.</param>
[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
public struct AccessRightInfo(uint mask, string name, AccessFlags flags)
{
	private IntPtr guidObjectType = NativeMethods.EmptyGuidPtr;
	...
	public AccessRightInfo(uint mask, string name, AccessFlags flags, Guid objType)
		: this(mask, name, flags) => ObjectTypeId = objType;
...
/// <summary>
/// Defines the mapping of generic access rights to specific and standard access rights for an object. When a client application requests
/// generic access to an object, that request is mapped to the access rights defined in this structure.
/// </summary>
/// <remarks>Initializes a new instance of the <see cref="GenericMapping"/> struct.</remarks>
...
public struct GenericMapping(uint read, uint write, uint execute, uint all)
{
...
/// <remarks>Initializes a new instance of the <see cref="InheritedFromInfo"/> struct.</remarks>
/// <param name="generationGap">The generation gap.</param>
/// <param name="ancestorName">Name of the ancestor.</param>
[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
public struct InheritedFromInfo(int generationGap, string ancestorName)
{
	/// <summary>
	...
	public static readonly InheritedFromInfo Explicit = new(0, null);

	/// <summary>ACE inheritance cannot be determined.</summary>
	public static readonly InheritedFromInfo Indeterminate = new(-1, null);
}

/// <summary>
/// Contains information about how access control entries (ACEs) can be inherited by child objects. The <see
/// cref="IAccessControlEditorDialogProvider.GetInheritTypes"/> method uses this structure to specify display strings that the access
/// control editor uses to initialize its property pages.
/// </summary>
/// <remarks>Initializes a new instance of the <see cref="InheritTypeInfo"/> struct.</remarks>
/// <param name="flags">The inheritance flags.</param>
/// <param name="name">The display name.</param>
[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
public struct InheritTypeInfo(InheritFlags flags, string name)
{
	private IntPtr guidObjectType = NativeMethods.EmptyGuidPtr;

	/// <summary>
	/// A set of <see cref="InheritFlags"/> that indicate the types of ACEs that can be inherited by the <see cref="ChildObjectTypeId"/>.
	/// These flags correspond to the AceFlags member of an ACE_HEADER structure.
	/// </summary>
	public InheritFlags Flags = flags;
	...
	public InheritTypeInfo(Guid childObjectType, InheritFlags flags, string name)
		: this(flags, name) => ChildObjectTypeId = childObjectType;

	/// <summary>
	/// The type of child object. This member can be <see cref="Guid.Empty"/>. The GUID corresponds to the InheritedObjectType member of
...
/// <summary>
/// Identifies an object type element in a hierarchy of object types. An array of ObjectTypeList structures to define a hierarchy of an
/// object and its subobjects, such as property sets and properties.
/// </summary>
[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
public struct ObjectTypeList
{
	private ushort level;
	private readonly ushort Sbz;
	...
	public ObjectTypeList(ushort level, Guid objType)
	{
		this.level = 0;
		Sbz = 0;
		guidObjectType = NativeMethods.EmptyGuidPtr;
	...
	public static readonly ObjectTypeList Self = new(0, Guid.Empty);
